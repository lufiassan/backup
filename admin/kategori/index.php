            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <a href="http://localhost/adminlte/admin/kategori/edit.php?" class="btn btn-primary btn-xs">edit</a>
                    <a href="http://localhost/adminlte/admin/kategori/hapus.php?" class="btn btn-danger btn-xs">hapus</a>
                  </td>
                </tr>
              </table>
            </div>
